...
class TestCalculator(unittest.TestCase):
    ...
    #@unittest.skip("Skipping addition test")
...
# To run individual test cases, use the following format<not working>:
#unittest.TextTestRunner().run(unittest.TestLoader().loadTestsFromName("TestCalculator.test_subtraction"))
